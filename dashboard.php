  ...
  <div class="container2 pb-5 pt-2">
    ...
    <div class="row ">
      ...
      <div class="col-md-4 mb-3  ">
        ...
        <button type="button" class="btn btn-success w-100"><a href="info.php" class="btns">Go to Sell Page</a></button>
      </div>
      ...
      <div class="col-md-4 mb-3 ">
        ...
        <button type="button" class="btn btn-success w-100"><a href="buy.php" class="btns">Go to Buy Page</a></button>
      </div>
      ...
      <div class="col-md-4 mb-3 ">
        ...
        <button type="button" class="btn btn-success w-100"><a href="waste.php" class="btns">Go to Info Page</a></button>
      </div>
